...
sm.taylor_diagram(
    ...
    np.array([1, 0.5, 0.8, 0.95, 0.6, 0.99]),   # R
    ...
    tickRMS = np.round(np.arange(0.2, 2, 0.2),3), colRMS = "g", styleRMS = ":", labelrms = "CRMSD",
    colsCOR = {"grid": "blue", "title": "b", "tick_labels": "b"}, styleCOR = "--", widthCOR = 1,
