...
print("Polynomial Regression, Operating point: Idle metrics")
print(metrics.head())
...
# Get metrics
metrics = polynomialReg.performance_metrics(train = train_results, test = test_results)
print("Polynomial Regression, Operating point: T/O metrics")
print(metrics.head())
